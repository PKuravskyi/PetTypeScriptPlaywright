...
test.describe(
	...
	() => {
		...
		test('2 Verify arts page visualisation (default sorting)', async ({
			artsPage,
		}) => {
			await artsPage.verifyPageHasScreenshot();
		});

		test('1 Verify arts page visualisation (ascending sorting)', async ({
			artsPage,
		}) => {
		...
		test('1 Verify arts page visualisation (descending sorting)', async ({
			artsPage,
		}) => {
